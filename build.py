...
<aside id="edits-panel" class="edits-panel">
  <div class="edits-head">Photo edits (<span id="edits-count">0</span>)
    <button id="edits-export">Export JSON</button></div>
  <div id="edits-list"></div>
  <p class="muted small">Edits are saved in this browser only. Use “Export JSON” to make them permanent in the project.</p>
</aside>
